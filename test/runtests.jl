...
# !!! Main.UserApp is configured as an alias for Main.OXEBankingSeguros and you might encounter it in some tests
using Main.OXEBankingSeguros, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "OXEBankingSeguros tests" begin
  @includetests ARGS
end
